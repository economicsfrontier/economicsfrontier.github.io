...
<p>
My interest in engineering began long before starting college. As a teenager and aspiring guitarist, I was fascinated by the likes of Eddie Van Halen and the sounds great guitarists could create. I could not afford the imported effects pedals they used, so I began studying electronics books, learning circuit fundamentals, and building my own effects pedals from individual components. I never quite managed to sound like Eddie, but the attempt may have accomplished something more consequential: it helped steer me toward electrical engineering. This was long before the internet made information readily accessible, so much of the learning came through experimentation, troubleshooting, and persistence. Looking back, those early projects sparked a curiosity about how complex systems work and weighed in my decision to pursue electrical engineering.
</p>
<p>
